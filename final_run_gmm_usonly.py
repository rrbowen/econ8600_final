...
data = pandas.read_csv("result_us.csv")
...
pyplot.savefig("scatter_gmm_US.png")
pyplot.close()
...
def run_gmm(n, data):
	...
	pyplot.savefig("scatter_gmm_US_" + str(n) + ".png")
	pyplot.close()
	return silhouette


gmm_silhouette_list_us = [ run_gmm(i+1, data) for i in range(7)]
print(gmm_silhouette_list_us)
