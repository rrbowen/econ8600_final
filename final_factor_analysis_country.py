...
dataset = pandas.read_csv("dataset_final_usonly.csv")
print(dataset)
print(dataset.shape)
...
#"result" is the dataset we will use for clustering.  US only

from numpy import asarray
from numpy import savetxt
savetxt('result_us.csv', result, delimiter=',')
